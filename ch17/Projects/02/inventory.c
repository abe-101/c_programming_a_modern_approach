...
/************************************************************
 * main: Promts the user to enter an operation code,        *
...
{
    char code;
    if ((inventory = malloc(sizeof(max_parts) * sizeof(struct part))) == NULL) {
 ...
 *         Prints an erroe message if the part doesn't      *
 ...
 *        quantity on hand. Parts are printed on the      *
